                             ...
                             int games_per_worker)
{
    ...
    for (int game_num = 0; game_num < games_per_worker; ++game_num) {
        Mcts_config config_candidate(1.4, 100, LogLevel::NONE, 0.0, 0.3, 0.0, queue_candidate, 10, false, 0);
        Mcts_config config_best     (1.4, 100, LogLevel::NONE, 0.0, 0.3, 0.0, queue_best,      10, false, 0);
...
int main(int argc, char** argv) {
    ...
    const int            GAMES_PER_SIDE   = 50;
    const std::vector<int> CHECKPOINT_LIST = {
        0, 600, 900, 1200, 1500, 1800, 2100, 2400, 2700, 3000,
