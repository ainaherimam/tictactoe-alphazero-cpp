...
Mcts_agent_selfplay::Mcts_agent_selfplay(const Mcts_config& config)
...
float Mcts_agent_selfplay::evaluate_position(const std::shared_ptr<Node>& node, Board board) {
